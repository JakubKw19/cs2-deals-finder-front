...
import { bitskinsPrice, buff163Price, csfloatPrice, csgoempirePrice, csgotmPrice, csgotraderPrice, csmoneyPrice, lootfarmPrice, skinportPrice, steamPrice, swapggPrice, youpinPrice } from "../../types/servertypes/marketPrices";
...
export const marketPrices = pgTable("market_prices", {
    ...
    csgoempirePrice: json("csgoempire_price").$type<csgoempirePrice>().notNull(),
    ...
    csgotraderPrice: json("csgotrader_price").$type<csgotraderPrice>().notNull(),
